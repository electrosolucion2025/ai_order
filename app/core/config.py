...
class Settings(BaseSettings):
    ...
    SERVER_HOST: AnyHttpUrl = Field("http://localhost:8000", example="http://localhost:8000")

    # Configuración de WhatsApp API
    WHATSAPP_API_URL: str = Field(..., env="WHATSAPP_API_URL", example="https://api.whatsapp.com/v1/messages")
    WHATSAPP_TOKEN: str = Field(..., env="WHATSAPP_TOKEN", example="your-whatsapp-token")
    ...
    # Configuración de BD
    DATABASE_URL: str = Field("sqlite:///./test.db", env="DATABASE_URL", example="postgresql://user:password@localhost/db")
